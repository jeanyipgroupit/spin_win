...
| Current chances:
|
| Hydrating Treatment       16.6%
| Hair Ampoule              25%
| Scalp Detox               16.6%
| $50 Service Voucher       16.8%
| Herbal Spa Protection     25%
| Product Hamper             0%
|
|--------------------------------------------------------------------------
*/
...
spinButton.addEventListener(
    ...
    function() {
        ...
        /*
        |--------------------------------------------------------------------------
        | Prevent double-click while spinning
        |--------------------------------------------------------------------------
        */
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | Make sure wheel continues forward
        |--------------------------------------------------------------------------
        */
            ...
            */
            ...
            if (progress < 1) {
                ...
                */
                ...
                |--------------------------------------------------------------------------
                | IMPORTANT:
                | Enable button again so user can spin
